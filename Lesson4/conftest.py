...
# для запуска с нужным языком pytest -s -v --language=fr test_items.py
# ддя запуска без графического интерфейса pytest -s -v --browser_name=chrome --language=fr --headless test_items.py